...
export const projects = [
  {
    ...
    goal: `When User first arrives at the game, it will randomly generate a board and start playing. User can start and stop the board. User can set up the board. User can clear the board. When User presses start, the game will play out. Each time the board changes, User can see how many generations have gone by.`,
    technologies: ["ES6", "React", "React Redux", "Redux Thunk"],
    href: "https://gurugumawaru.github.io/FCC_game_of_life/",
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1522765892/FCC_Game_Of_Life_resized_ddofex.png",
    screenshotLabel: "Game of Life"
  },
  {
    id: 13,
    title: "Event Calendar",
    description: "React Project for Interview Test",
    goal: `Conflicting events should be the same width, and should not overlap. Max event width is 200px. Event background color is #E2ECF5 with #6E9ECF border color. Event font is Open Sans, 14px. Calendar time font is Open Sans with around 200 font weight, 16px large, 12px small. Titles should be 1 line and should not overflow outside the calendar-event box. If the title is too long to fit, ellipsis (“…”) should be used. Events will be between 8am to 5pm (there’s a label for 5pm but events will not exceed 5pm). Calendar will cover only one day. User should be able to add/remove events from his calendar. User should be able to export his calendar in JSON (specified format). User should be able to login and persist his inputs between logins.`,
    technologies: [
      "ES6",
      "React",
      "React Redux",
    ...
    href: "https://damp-meadow-56363.herokuapp.com/",
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1520769538/Test__Event-Calendar_wcjvnl.png",
    screenshotLabel: "Event Calendar"
  },
  {
    id: 12,
    title: "Recipe Box",
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1503127487/FCC_RecipeBox_resized_laqlnu.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1501691208/FCC_Camper_Leaderboard_resized_of8hrf.jpg",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1500576485/FCC_Markdown_Previewer_resized_og4gon.jpg",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1499783455/FCC_Simon_Game_resized_gezwj9.jpg",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1498579433/FCC_TicTacToe_resized_kux8jv.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1495016958/FCC_Pomodoro_Clock_resized_v7eext.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1493117490/FCC_Calculator_resized_olupov.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1493116898/FCC_Twitchtv_resized_o8ghsw.jpg",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1493112694/FCC_Wiki_Viewer_resized_r0fcmb.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1493111811/FCC_Weather-App_resized_2_x87yny.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1493112050/FCC_Random-Quote_resized_2_gkowtc.png",
  ...
  },
  {
    ...
    screenshotLink:
      "https://res.cloudinary.com/gurugumawaru/image/upload/v1492425629/FCC_Stephen-King_resized_mgnfei.jpg",
